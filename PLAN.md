...
- [x] **Flow Manager Implementation (The Core Workflow)**:
    ...
    7.  **Agent Selection**: Scan remote and select agent (Claude, Antigravity, Kilo Code, Copilot). ✅
...
- [ ] **Remote VM Bootstrapper**:
    - Connect to a new remote VM and install baseline tooling (git, tmux, go, nodejs, npm, curl, claude, cursor, agy, kilo, acli).
